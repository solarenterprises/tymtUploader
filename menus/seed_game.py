from PyQt6.QtWidgets import QMainWindow, QLabel, QVBoxLayout, QWidget, QPushButton, QFileDialog, QMessageBox, QInputDialog, QTextEdit
...
class SeedGame(QMainWindow):
    def __init__(self):
        ...
        # Timer to update console log
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.update_console_log)
    ...
    def update_console_log(self):
        stats = get_torrent_stats()
        stats_message = "\n".join(stats)
        self.console_log.setPlainText(stats_message)
